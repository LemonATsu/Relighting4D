...
cfg.cache_shape = False
cfg.train_shape = False
cfg.vis_shape = False
...
cfg.vis_nble = False
cfg.vis_relight_npose = False
cfg.train_sdf = False
cfg.train_neus = False
cfg.vis_mesh = False
cfg.vis_sdf_mesh = False
...
def make_cfg(args):
    ...
    if cfg.cache_shape:
        cfg.merge_from_other_cfg(cfg.cache_shape_cfg)

    if cfg.train_shape:
        cfg.merge_from_other_cfg(cfg.train_shape_cfg)

    if cfg.vis_shape:
        cfg.merge_from_other_cfg(cfg.vis_shape_cfg)
    
    if cfg.train_relight:
        cfg.merge_from_other_cfg(cfg.train_relight_cfg)
    ...
    if cfg.vis_nba:
        cfg.merge_from_other_cfg(cfg.vis_nba_cfg)

    if cfg.train_nble:
        cfg.merge_from_other_cfg(cfg.train_nble_cfg)

    if cfg.vis_nble:
        cfg.merge_from_other_cfg(cfg.vis_nble_cfg)
    
    if cfg.vis_relight_npose:
        cfg.merge_from_other_cfg(cfg.relight_npose_cfg)

    if cfg.train_sdf:
        cfg.merge_from_other_cfg(cfg.train_sdf_cfg)

    if cfg.train_neus:
        cfg.merge_from_other_cfg(cfg.train_neus_cfg)
    
    if cfg.vis_sdf_mesh:
        cfg.merge_from_other_cfg(cfg.sdf_mesh_cfg)
