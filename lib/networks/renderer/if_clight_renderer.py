...
class Renderer:
    ...
    def get_pixel_value(self, ray_o, ray_d, near, far, feature_volume,
        ...
        if hasattr(self.net, 'calculate_density_color'):
            calculate_density_color = self.net.calculate_density_color
        else:
            calculate_density_color = self.net.net.neuralbody.calculate_density_color

        #raw_decoder = lambda x_point, viewdir_val: self.net.calculate_density_color(
        raw_decoder = lambda x_point, viewdir_val: calculate_density_color(
    ...
    def render(self, batch):
        ...
        if hasattr(self.net, 'encode_sparse_voxels'):
