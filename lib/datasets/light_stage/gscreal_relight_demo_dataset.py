...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        place_holderx3 = np.zeros_like(ray_d)
        place_holderx1 = place_holderx3[:, 0]
        ...
        ret = {
            ...
            'msk': msk,
            'surf': place_holderx3,
            'normal': place_holderx3,
            'alpha': place_holderx1,
            'lvis': place_holderx1,
            'smpl_features': place_holderx3,
            'img': place_holderx3,
            'img_gt': place_holderx3,
            'light_map': 0
        }
